...
urlpatterns = patterns('mailman_django.views',
    ...
    url(r'^lists/(?P<fqdn_listname>[^/]+)/$', 'list_subscriptions', name = 'list_info'),
    url(r'^lists/(?P<fqdn_listname>.+)/subscriptions/$', 'list_subscriptions', kwargs={"option": None}, name = 'list_subscriptions'),
    url(r'^lists/(?P<fqdn_listname>.+)/subscriptions/subscribe$', 'list_subscriptions', kwargs={"option": "subscribe"}, name = 'list_subscriptions'),
    url(r'^lists/(?P<fqdn_listname>.+)/subscriptions/unsubscribe$', 'list_subscriptions', kwargs={"option": "unsubscribe"}, name = 'list_subscriptions'),
