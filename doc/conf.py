# -*- coding: utf-8 -*-
#
# mailman_django documentation build configuration file, created by
...
htmlhelp_basename = 'mailman_djangodoc'
...
latex_documents = [
  ('index', 'mailman_django.tex', u'mailman\\_django Documentation',
...
man_pages = [
    ('index', 'mailman_django', u'mailman_django Documentation',
     [u'Benedict Stein'], 1)
]
